...
import examio_beta20210527 as examio  # TODO reset when ready
...
#           qstartdate (datetime:date): earliest date that questions should be included from
#           qenddate (datetime:date): latest date that questions should be included from
...
def getconfig():
    ...
    qstarttag = "questions start:"
    qendtag = "questions end:"
    topictag = "topics:"
    ...
    return questionspath, signupspath, hasschedule, examtype, examdate, studentgroups, onefileperstudent, qstartdate, qenddate  #, topics, difficulties
...
questionspath, signupspath, hasschedule, examtype, examdate, studentgroups, onefileperstudent, qstartdate, qenddate = getconfig()
