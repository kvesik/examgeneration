...
class ExamSession:
    ...
    def getuniquequestion(self, qssofar, topic, difficulty="", otherstudents=[], alreadyused=[], qspool={}):
        ...
        # print("eligibleq length is",len(eligibleqs))
        ...
        while (question in qssofar) \
            ...
            if numtries > 50:
                ...
                # for now, lift the restriction of no repeated source for this student and just go with no repeated ID
                if isqsourceinquestions(question.source, alreadyused):
                    ...
                    print("couldn't find a question not in a group member's exam for " + question.topic + " / " + question.difficulty)
                break
            question = random.sample(eligibleqs, 1)[0]
            numtries += 1
    ...
    def collectmidtermorfinalquestions(self, extype, sid="", examdate = None):
        ...
        # 20201025
        # changed from order by easy/med first, then everything else, to...
